...
?>
	<div class="forms1">
		...
		<form name"FormUsu" method="POST" action="" id="formgen" onSubmit="return confirm('Por  favor primero  verifique  los datos ingresados  antes de hacer clic en  !aceptar!')" enctype="multipart/form-data">
			<div class="row">
			...
			<div class="row">
				...
				<div class="form-group col-lg-6">	
					...
					<select class="form-control" name="perfil">
						...
						?>
							<option value="<?php echo $datper[$i]['idperfil']; ?>"><?php echo $datper[$i]['nomper']; ?></option>
						<?php
							}
						?>
					</select>
			...
			<div class="row">
				...
				<div class="form-group col-lg-6">	
					<label for="Nombre de archivo">Foto: </label>
