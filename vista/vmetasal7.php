		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">Salud sexual y reproductiva</td>
				</tr>
				<tr>
				...
				<tr>
					<td>Aunar esfuerzos para desarrollar las acciones programadas en el Plan de Intervenciones Colectivas PIC 2015 - SSR</td>
					<td>15-Enero</td>
					<td>15-Diciembre</td>
					<td>Programa para la prevencion de embarazos en la poblacion adolescente del Municipio de Chia  </td>
					<td>	
